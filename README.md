This is unfinished REST API example for Prinful API with memcache use for persistent file caching mechanism (5 minutes but can be changed via config.php file value).
